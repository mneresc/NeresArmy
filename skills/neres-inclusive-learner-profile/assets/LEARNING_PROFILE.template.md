...
[DESCONHECIDO] Preencher após confirmação do usuário.

## 2. Escopo, objetivo e prazo
[DESCONHECIDO] Preencher objetivo observável e prazo.

## 3. Fontes e evidências analisadas
[DESCONHECIDO] Nenhuma fonte analisada ainda.

## 4. Síntese operacional
[INFERÊNCIA — confiança baixa] Ainda não há amostra suficiente.

## 5. Forças e teto de desafio
[DESCONHECIDO] A medir por competência.

## 6. Barreiras funcionais e de acesso
[DESCONHECIDO] Investigar somente se relevante ao objetivo.
...
- [DESCONHECIDO] Registrar necessidade funcional autorizada.
