...
Use the smallest installed BMAD workflow that produces adequate acceptance and
handoff. Typo, local validation, focused test and small bug do not need a full PRD.
...
3. Select real installed BMAD skills by their discovered names.
