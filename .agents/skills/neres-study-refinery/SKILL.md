...
This is the repository discovery entrypoint for Agent Skills clients, Codex,
Antigravity, OpenCode, and Devin.

Read and follow the complete canonical instructions at:

`../../../skills/neres-study-refinery/SKILL.md`

Run the canonical standalone executable at:

`../../../skills/neres-study-refinery/dist/neres-study-refinery.mjs`
