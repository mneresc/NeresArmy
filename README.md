...
| --- | --- | --- |
| `neres-agentic-bmad` | Instala entry points e onze subagentes no Codex, OpenCode ou Devin CLI/Desktop, com contexto compacto, gates determinísticos e routing adequado a cada runtime. | [README](skills/neres-agentic-bmad/README.md) · [Cookbook](skills/neres-agentic-bmad/docs/COOKBOOK.md) |
